...
public class EmailService {
    ...
    public void sendEmail(NotificationEvent notificationEvent) {
        ...
        @SuppressWarnings("null")
    public void sendActivationEmail(UserEvent userEvent) {
        ...
        try {
            ...
            map.put("userName", userEvent.getName());
            map.put("activationLink", String.format("%s/verify/%s", frontendUrl, userEvent.getToken()));
